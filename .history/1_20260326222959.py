...
with open("a_stock_sentiment_system/examples/execution_usage.py", "w", encoding="utf-8") as f:
    f.write(usage_example)

print("✅ examples/execution_usage.py 创建完成")
...
with open("a_stock_sentiment_system/docs/timing_cheatsheet.md", "w", encoding="utf-8") as f:
    f.write(summary_table)

os.makedirs("a_stock_sentiment_system/docs", exist_ok=True)
print("✅ docs/timing_cheatsheet.md 创建完成")
