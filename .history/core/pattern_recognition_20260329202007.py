...
class PatternRecognition:
    ...
    def detect_first_board_breakout(self, today_df: pd.DataFrame, yesterday_df: pd.DataFrame = None, date_str: str = None) -> List[PatternSignal]:
        """
        首板突破模式识别
        引用: core.pattern.first_board_breakout.detect_first_board_simple
        """
        signals = []
        ...
        try:
            # 调用first_board_breakout.py中的简化检测方法
            from core.pattern.first_board_breakout import detect_first_board_simple
            trade_signals = detect_first_board_simple(today_df, yesterday_df, date_str)
